...
function Profile() {
  ...
  return (
    <div className="bg-[#f1f1f1] flex items-center justify-center h-screen">
      <UserNav />
      <div className="w-[450px] h-[500px] flex rounded-lg bg-slate-50 shadow-lg shadow-black relative overflow-hidden">
        <Image
          src={"/bg.jpeg"}
          fill
          objectFit="cover"
        ...
        <div className="info flex flex-col items-center text-black w-full z-10">
          <div className="w-full px-8 py-8">
            ...
            <div className="flex hover:bg-[#6662c2] items-center px-3 py-1 bg-[#4598FE] w-full justify-center text-white space-x-3 rounded-lg">
              <MdOutlineEditNote size={25} />
              <button className="uppercase">Edit</button></div>
          </div>
        </div>
      </div>
    </div>
